...
from network.noise_layers import data, models
from network.noise_layers.util import util
...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument("--checkpoints_dir", type=str, default="network/noise_layers/ckpts", help="models are saved here")
        # model parameters
        parser.add_argument(
            "--model",
            type=str,
